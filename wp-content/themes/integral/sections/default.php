        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12 text-center">
                    <a href="<?php echo get_theme_mod( 'integral_default_header_btn1url', '#' ); ?>" class="btn btn-md btn-ot"><?php echo get_theme_mod( 'integral_default_header_btn1', 'View Features' ); ?></a>
                </div>
                ...
                <div class="col-md-12 text-center">
                    <a href="<?php echo get_theme_mod( 'integral_default_header_btn2url', '#' ); ?>" class="btn btn-md btn-not"><?php echo get_theme_mod( 'integral_default_header_btn2', 'Download Now' ); ?></a>
                </div>
