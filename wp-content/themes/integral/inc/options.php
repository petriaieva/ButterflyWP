    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
                     ...
                     array(
                            ...
                            'output'    => array('background-color' => '.btn-not, #mc-embedded-subscribe-form .button, .ctct-embed-signup .ctct-button'),
                            'subtitle' => __( 'Pick a color for the main button (default is #00aded).', 'integral' ),
                            'default'     => '#00aded',
                        ),
                     ...
                     array(
                            ...
                            'output'    => array('border-color' => '.navbar-default li a:hover, .navbar-default .navbar-nav > li > a:hover', 'color' => 'a, a:hover, a:focus, .heading .fa, .pagemeta a:link,.pagemeta a:visited,.team .t-type', 'background' => '.lite h2.smalltitle span, .sidebar h2:after, .content h2:after'),
...
// -> START Blog
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
                    ...
                    array(
                            ...
                            'default' => '<p class="text-center"><a href="#">Read the blog &#8594;</a></p>'
                    ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
                    ...
                    'desc'    => __( '<small>Custom HTML allowed', 'integral' ),
