...
class Integral_Projects_Single_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array( 'classname' => 'wcp_image', 'description' => 'Add a project to the homepage single projects section.' );
        parent::__construct( 'Integral_projects_single', 'Integral - Single Project Widget', $widget_ops );
    ...
    function update( $new_instance, $old_instance ) {
        ...
        $instance['project_date'] = strip_tags($new_instance['project_date']);
        $instance['project_client'] = strip_tags($new_instance['project_client']);
        $instance['project_skills'] = strip_tags($new_instance['project_skills']);
        $instance['project_url'] = strip_tags($new_instance['project_url']);
...
?>
    <p>
        ...
        <input type="hidden" class="gallery_values" name="<?php echo $this->get_field_name('gallery'); ?>" value="<?php echo $instance['gallery']; ?>">
        </fieldset>
    <p>
    ...
    <p>
        ...
        <input class="widefat" id="<?php echo $this->get_field_id('project_date'); ?>" name="<?php echo $this->get_field_name('project_date'); ?>" type="date" value="<?php echo $instance['project_date']; ?>" />
    </p>
    <p>
        <label for="<?php echo $this->get_field_id('project_client'); ?>"><?php _e('Project Client', 'integral'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('project_client'); ?>" name="<?php echo $this->get_field_name('project_client'); ?>" type="text" value="<?php echo $instance['project_client']; ?>" />
    </p>
    <p>
        <label for="<?php echo $this->get_field_id('project_skills'); ?>"><?php _e('Project Skills', 'integral'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('project_skills'); ?>" name="<?php echo $this->get_field_name('project_skills'); ?>" type="text" value="<?php echo $instance['project_skills']; ?>" />
    </p>
    <p>
        <label for="<?php echo $this->get_field_id('project_url'); ?>"><?php _e('Project URL', 'integral'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('project_url'); ?>" name="<?php echo $this->get_field_name('project_url'); ?>" type="text" value="<?php echo $instance['project_url']; ?>" />
    </p> 
...
add_action( 'widgets_init', create_function( '', "register_widget( 'Integral_Projects_Single_Widget' );" ) );
